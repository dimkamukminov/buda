...
def drawBlock(block_x, block_y, color, pixelx=None, pixely=None):
    ...
    print(pixelx, pixely, block)
    pg.draw.rect(display_surf, colors[color], (pixelx + 1, pixely + 1, block - 1, block - 1), 3)
    pg.draw.rect(display_surf, lightcolors[color], (pixelx + 1, pixely + 1, block - 4, block - 4), 3)
    pg.draw.circle(display_surf, colors[color], (int(pixelx + block / 2), int(pixely + block / 2)), 5)
